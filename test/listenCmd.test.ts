...
describe('assembleDuplexScan', () => {
  it('should assemble pages in natural order for PAGE_WISE mode', () => {
    ...
    const result = assembleDuplexScan(frontScan, backScan, DuplexAssemblyMode.PAGE_WISE);

    expect(result.elements).to.deep.equal([
      { path: 'front1.png', pageNumber: 1, width: 100, height: 200, xResolution: 300, yResolution: 300 },
      { path: 'back1.png', pageNumber: 1, width: 100, height: 200, xResolution: 300, yResolution: 300 },
      { path: 'front2.png', pageNumber: 2, width: 100, height: 200, xResolution: 300, yResolution: 300 },
      { path: 'back2.png', pageNumber: 2, width: 100, height: 200, xResolution: 300, yResolution: 300 }
    ]);
  });
  ...
  it('should reverse backs for DOCUMENT_WISE mode', () => {
    ...
    const result = assembleDuplexScan(frontScan, backScan, DuplexAssemblyMode.DOCUMENT_WISE);
  ...
  it('should reverse fronts for REVERSE_FRONT mode', () => {
    ...
    const result = assembleDuplexScan(frontScan, backScan, DuplexAssemblyMode.REVERSE_FRONT);
  ...
  it('should reverse both fronts and backs for REVERSE_BOTH mode', () => {
    ...
    const result = assembleDuplexScan(frontScan, backScan, DuplexAssemblyMode.REVERSE_BOTH);
