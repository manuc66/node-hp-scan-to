...
![npm](https://img.shields.io/npm/dt/node-hp-scan-to)
![Docker Pulls](https://img.shields.io/docker/pulls/manuc66/node-hp-scan-to)
...
The `Officejet 6700 Premium` is  known to not be working but should be close to working, see #325
